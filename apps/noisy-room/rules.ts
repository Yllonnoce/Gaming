      ...
      blocks: [
        {
          ...
          items: [
            ...
            "Everyone's microphone starts at half level, because a phone a hand's width from your mouth is loud. If people say you're quiet, slide Mic level up; it works before and during the call, and your setting is remembered.",
            "Wrong microphone? The Microphone menu in the call lists what your phone has, including earbuds; a Speaker menu appears on browsers that let a page choose the output (most phones route it themselves).",
